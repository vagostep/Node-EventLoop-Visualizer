      ...
      <Card.Body padding="1rem">
        <Card.Title color="#fff" fontWeight="bold" fontSize="20px">
          <Flex justifyContent="space-between">
            <Text textStyle={{ base: "md", sm: "xs", md: "xl" }}>Metrics</Text>
            <Text
              textStyle="xs"
              color="#339933"
              mt="8px"
        ...
        <SimpleGrid columns={{ base: 3, md: 2 }} gap={2} height="100%" padding="16px">
          <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={1}>
            <Icon size="lg">
              <GrPowerCycle />
            </Icon>
            <Text textStyle={{ base: "xs", lg: "md" }}>Loop Count</Text>
          ...
          <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={1}>
            ...
            <Text textStyle={{ base: "xs", lg: "md" }}>Events</Text>
          ...
          <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={1}>
            ...
            <Text textStyle={{ base: "xs", lg: "md" }}>Events Waiting</Text>
