...
import './ColorModeCorner.css';
import { useColorMode, useColorModeValue } from './ui/color-mode';

const ColorModeCorner: React.FC = () => {
...
export default ColorModeCorner;
